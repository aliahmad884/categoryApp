...
export default function ItemPanel() {
    ...
    useEffect(
        () => {
            fetch("https://new-server-001-19ce08ca82df.herokuapp.com/devices")
        ...
        <>
            <Container fluid className='my-5' >
                <Row>
                    <Col className='col'>
                        <Card>
                            <Card.Header className='bg-info p-3'><h4><i className='fa solid fa-list'></i> Electronic Devices</h4></Card.Header>
                            ...
                            <Card.Body>
                                {categoriesList.map(c => <ElectronicItems data={c} key={c._id} />)}
                            </Card.Body>
...
export function ElectronicItems(props) {
    ...
    let image = "";
    if (props.data.Parent === "Mobile") {
        image = `Images/Categories/mobile.png`;
    }
    else if (props.data.Parent === "Laptop") {
            ...
            <Modal
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group controlId="formFile" className="dnone pt-2">
                            <Form.Label>Select Image</Form.Label>
                            <Form.Control onChange={e => updateImage(e.target.files[0].name)} type="file" />
                        </Form.Group>
                    </Form>
