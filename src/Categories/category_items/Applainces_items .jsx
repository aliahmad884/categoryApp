...
export default function ApplaincesItemPanel() {
    const [categoriesList, updateCategoriesList] = useState([]);
    useEffect(
        () => {
            fetch("https://new-server-001-19ce08ca82df.herokuapp.com/appliances")
        ...
        <>
            <Container fluid className='my-5' >
                <Row>
                    <Col className='col'>
                        <Card>
                            <Card.Header className='bg-info p-3'><h4><i className='fa solid fa-list'></i> TV & Home Applainces</h4></Card.Header>
                            ...
                            <Card.Body>
                                {categoriesList.map(c => <ApplaincesItems data={c} key={c.Id} />)}
                            </Card.Body>
...
export function ApplaincesItems(props) {
    ...
    let image = "";
    if (props.data.Parent === "Kitchen-Accessories") {
        image = `Images/Categories/kitchen.png`;
    }
    else if (props.data.Parent === "Entertainment") {
        image = `Images/Categories/lcd.png`;
    }
    else if (props.data.Parent === "Refrigerator") {
        image = `Images/Categories/refrigerator.png`;
    }
